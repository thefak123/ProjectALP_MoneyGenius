            ...
            NavigationStack(path: $path){
                VStack{
                    ...
                    if view == "budgetscreen" {
                        ...
                        TransactionScreen(path: $path).navigationBarTitle("Transaction")
                        ...
                        AddUpReminderScreen(path: $path).navigationBarTitle("Add Reminder")
                    }
                    ...
                    AddTransactionScreen(trans: trans,type:trans.categoryType, path: $path).navigationBarTitle("Update Transaction")
